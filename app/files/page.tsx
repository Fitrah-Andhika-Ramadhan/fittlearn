        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center mb-4">
              ...
              <h1 className="text-4xl font-bold text-white drop-shadow-md">My Study Files</h1>
            </div>
            <p className="text-purple-200">Organize and manage your college files, notes, and study materials</p>
          </div>
              ...
              <div className="grid md:grid-cols-4 gap-4">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-white/5 border-white/10 text-white placeholder-gray-400 focus-visible:ring-purple-500"
                  />
                </div>
          ...
          <div className="space-y-4">
            {filteredFiles.map((file) => (
              <Card key={file.id} className="hover:shadow-lg transition-shadow bg-white/5 border-white/10 backdrop-blur-md text-white">
                <CardContent className="p-6">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-4 flex-1">
                      <div className="flex-shrink-0">{getFileIcon(file.type)}</div>
                      <div className="flex-1 min-w-0">
                        <h3 className="text-lg font-medium text-white mb-2 drop-shadow-sm">{file.name}</h3>
                        <p className="text-purple-200 text-sm mb-3">{file.description}</p>
