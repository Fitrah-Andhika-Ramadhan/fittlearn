    ...
    <div className="flex relative w-full">
      ...
      <div className="w-1/2 flex flex-col justify-center relative pb-20">
        <div className="space-y-4 mb-10">
          ...
          <p className="text-lg md:text-xl text-purple-200/80 font-light max-w-lg mt-6 leading-relaxed">
            A passionate <strong className="font-semibold text-white">Web Developer</strong> & <strong className="font-semibold text-white">System Analyst</strong> based in Bandung, Indonesia. I build modern, beautiful, and intelligent web applications.
          </p>
        </div>
        
        <div className="flex space-x-6">
          <button className="px-8 py-3 rounded-full bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition font-medium text-sm">
            Hire Me
          </button>
        ...
        <div className="w-full max-w-lg bg-[#1a153a]/80 backdrop-blur-2xl border border-white/10 rounded-[2rem] p-10 flex space-x-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          <div className="w-5/12">
            ...
            <p className="text-xs text-gray-400 leading-relaxed mb-6">
              I'm very approachable and would love to speak to you. Feel free to call, send me an email. Follow me in social media or simply complete this enquiry form.
            </p>
            <div className="text-xs font-medium text-white/80">
              <p>📞 +62 877 6028 7039</p>
              <p className="mt-1">✉️ fitrah.andhika@email.com</p>
            </div>
          </div>
