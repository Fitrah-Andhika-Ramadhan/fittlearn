    ...
    <div className="w-full text-white">
      <div className="w-full py-8">
        <div className="max-w-6xl mx-auto">
          {/* Dashboard Header */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-white mb-2 drop-shadow-md">Dashboard</h1>
            <p className="text-purple-200">Manage your document summaries</p>
          </div>
            ...
            <CardContent>
              <div className="flex items-center space-x-2">
                ...
                <Input
                  ...
                  className="flex-1 bg-white/5 border-white/10 text-white placeholder-gray-400 focus-visible:ring-purple-500"
                />
              </div>
            </CardContent>
          </Card>
          ...
          <div className="space-y-4">
            {filteredSummaries.map((summary) => (
              <Card key={summary.id} className="hover:shadow-lg transition-shadow bg-white/5 border-white/10 backdrop-blur-md text-white">
                <CardHeader>
